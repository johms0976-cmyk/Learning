...
const PHON = {
 ...
 "O": {
  ...
  "name": "oh",
  "type": "vowel",
  "fixed": "tts was 'awe' — that is the THOUGHT vowel, not the LOT vowel. No text string gets short o right across dialects. RECORD short-o (the vowel in 'hot'). Until then the engine says the keyword, octopus, exactly as it does for the stops."
 },
 "U": {
  "file": "uh",
  "tts": "uh",
 ...
 "WH": {
  ...
  "type": "cont",
  "digraph": true,
  "note": "/w/ for almost every child now. Kept separate from W so 'when' splits as WH-E-N and the initial-sound games stay honest."
 },
 "PH": {
  "file": "fff",
  "tts": "ffff",
 ...
 "OO": {
  ...
  "type": "vowel",
  "digraph": true,
  "note": "long oo (moon). Short oo (book) is the same spelling — set-for-variability: try one, then the other."
 },
 "EA": {
  "file": "eee",
  "tts": "eee",
 ...
 "EA_E": {
  ...
  "digraph": true,
  "surface": "EA",
  "note": "bread, head, feather — EA's second sound"
 },
 "ER": {
  "file": "er",
  "tts": "err",
 ...
 "OA": {
  ...
  "type": "vowel",
  "digraph": true,
  "fixed": "was sharing the 'oh' file with short O. Two different sounds cannot share one recording."
 },
 "IGH": {
  "file": "eye",
  "tts": "eye",
...
const TH_VOICED = ["THE","THIS","THAT","THESE","THOSE","THERE","THEIR","THEY","THEM","THEN","THAN","THOUGH","THUS","MOTHER","FATHER","BROTHER","ANOTHER","OTHER","TOGETHER","WEATHER","FEATHER","LEATHER","BATHE","BREATHE","CLOTHES","SMOOTH","WITH","WITHOUT"];
...
{no:9, region:"Hilltop Mill", art:"🏔️",
 ...
 kind:"family", teaches:["LL","SS","FF","ZZ"], rime:"ILL",
...
{no:9, region:"Puppy Point", art:"🐶",
 ...
 kind:"ending", teaches:["Y_E"], suffix:"Y", suffixSound:"eee",
...
{no:10, region:"Clockwork Harbour", art:"🕰️",
 ...
 kind:"family", teaches:["CK"], rime:"OCK",
...
{no:6, region:"Three Ways", art:"🛤️",
 grad:"linear-gradient(135deg,#A8D8C9,#357A66)",
 kind:"digraph", teaches:["TH","TH_V"], onset:"TH",
...
{no:5, region:"The Ladder Down", art:"🪜",
 grad:"linear-gradient(135deg,#C4B7A8,#6B5A42)",
 kind:"family", teaches:["WH"], rime:"ENT",
...
{no:9, region:"The Wishing Well", art:"🔔",
 ...
 kind:"family", teaches:["ALL"], rime:"ELL",
...
{no:8, region:"The Chimp's Chest", art:"🐒",
 ...
 kind:"digraph", teaches:["CH","TCH"], onset:"CH",
...
{no:9, region:"Thorn Thicket", art:"🌿",
 ...
 kind:"digraph", teaches:["TH_U"], onset:"TH",
...
{no:7, region:"The Sleeping Seal", art:"🦭",
 ...
 kind:"pattern", teaches:["EA","EA_E"], rime:"EACH", pattern:"vowelTeam",
...
{no:10, region:"The Deep Blue Trench", art:"🐋",
 ...
 kind:"review", teaches:["OU","OW","OI","OY"],
...
{no:5, region:"The Bird Garden", art:"🌱",
 ...
 kind:"pattern", teaches:["IR","UR"], pattern:"vowelTeam", machine:false,
...
{no:6, region:"The Light at Night", art:"🌟",
 ...
 kind:"pattern", teaches:["IGH","Y_I"], rime:"IGHT", pattern:"vowelTeam",
...
{no:8, region:"The Stork's Fork", art:"🍴",
 ...
 kind:"pattern", teaches:["OR","AR","AW"], rime:"ORN", pattern:"vowelTeam",
