...
const Profiles = (function () {
  ...
  /* Number Land saves { places:{index:stars}, right, asked, ms } —
     one flat record, because its places run in a single line
     rather than being grouped into maps the way Word Land's are. */
  function sumNumberLand(d) {
    ...
    return { lines: [[places, 'place finished', 'places finished'], [stars, 'star', 'stars']],
             correct: right, wrong: Math.max(0, asked - right), ms: d.ms || 0 };
  }
